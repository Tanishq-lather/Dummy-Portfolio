        ...
        <div className="mt-8 gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0}} transition={{duration: 0.8, ease: "easeOut"}} viewport={{ once: true, amount: 0.2 }} className="">
                ...
                <div className="w-full md:w-3/4 mt-6 pl-8 md:pl-28 pr-2 md:pr-0">
                    <img src="public/assets/C - Project_1.jpg" alt="Project 1" className='rounded-xl'/>
                </div>
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0}} transition={{duration: 0.8, ease: "easeOut"}} viewport={{ once: true, amount: 0.2 }} className="">
                ...
                <div className="w-full md:w-3/4 mt-6 pl-8 md:pl-28 pr-2 md:pr-0">
                    <img src="public/assets/C - Project_2.jpg" alt="Project 2" className='rounded-xl'/>
                </div>
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0}} transition={{duration: 0.8, ease: "easeOut"}} viewport={{ once: true, amount: 0.2 }} className="">
                ...
                <div className="w-full md:w-3/4 mt-6 pl-8 md:pl-28 pr-2 md:pr-0">
                    <img src="public/assets/C - Project_3.jpg" alt="Project 3" className='rounded-xl'/>
                </div>
